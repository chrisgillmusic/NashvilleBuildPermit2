  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6">
      <div className="w-full max-w-sm rounded-[28px] border border-white/70 bg-white/90 px-8 py-12 text-center shadow-[0_24px_80px_rgba(43,37,20,0.12)] backdrop-blur">
        <div className="text-[11px] font-semibold uppercase tracking-[0.28em] text-stone-500">BidHammer Jacksonville</div>
        <h1 className="mt-4 font-display text-4xl text-stone-950">Scanning Jacksonville permit activity</h1>
